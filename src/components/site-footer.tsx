  ...
  return (
    <footer className="mt-16 border-t border-slate-200 bg-white">
      <div className="mx-auto grid max-w-6xl gap-8 px-4 py-10 md:grid-cols-3">
        <div>
          <h3 className="text-base font-semibold text-slate-900">Tienda Minimal</h3>
        ...
        <div>
          ...
          <ul className="mt-2 space-y-1 text-sm text-slate-500">
            <li><Link to="/products" className="hover:text-slate-900">Catálogo</Link></li>
            <li><Link to="/checkout" className="hover:text-slate-900">Checkout</Link></li>
            <li><Link to="/track" className="hover:text-slate-900">Seguimiento</Link></li>
          </ul>
        </div>
